...
do
	...
	buffParticle.Color = ColorSequence.new(Color3.fromRGB(35, 178, 255), Color3.fromRGB(255, 255, 255))
	buffParticle.Parent = stealth
	...
	glow.Color = ColorSequence.new(Color3.fromRGB(27, 60, 111), Color3.fromRGB(27, 60, 111))
	glow.Parent = stealth
end
