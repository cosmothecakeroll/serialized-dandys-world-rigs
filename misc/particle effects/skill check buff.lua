local skillCheck = Instance.new("Folder")
skillCheck.Name = "SkillCheck"
do
	...
	buffParticle.Color = ColorSequence.new(Color3.fromRGB(255, 120, 30), Color3.fromRGB(255, 255, 255))
	buffParticle.Parent = skillCheck
	...
	glow.Color = ColorSequence.new(Color3.fromRGB(111, 57, 25), Color3.fromRGB(111, 57, 25))
	glow.Parent = skillCheck
end
