...
local flowerBud = Instance.new("Model")
flowerBud.Name = "FlowerBud"
do
	local flowerBud_2 = Instance.new("ModuleScript")
	flowerBud_2.Name = "FlowerBud"
	flowerBud_2.Parent = flowerBud
	...
	frontRightLeg.TextureID = "rbxassetid://132699111454634"
	...
	frontRightLeg.CFrame = CFrame.new(Vector3.new(-53.0427, 2.365, -23.795)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		frontRightLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://111246881373677", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		frontRightLeg_2.TextureID = "rbxassetid://82894932470419"
		...
		frontRightLeg_2.CFrame = CFrame.new(Vector3.new(-53.0427, 2.365, -23.795)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		do
	...
	frontRightLeg.Parent = flowerBud
	...
	frontLeftLeg.TextureID = "rbxassetid://132699111454634"
	...
	frontLeftLeg.CFrame = CFrame.new(Vector3.new(-53.0594, 2.3751, -25.3957)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		frontLeftLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://70807943970535", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		frontLeftLeg_2.TextureID = "rbxassetid://82894932470419"
		...
		frontLeftLeg_2.CFrame = CFrame.new(Vector3.new(-53.0594, 2.3751, -25.3957)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	tail.TextureID = "rbxassetid://132699111454634"
	tail.Name = "Tail"
	tail.Transparency = 1
	tail.CanQuery = false
	tail.CanTouch = false
	...
	tail.CFrame = CFrame.new(Vector3.new(-55.6056, 3.1784, -24.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		tail_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://96106407816565", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		tail_2.TextureID = "rbxassetid://82894932470419"
		tail_2.Name = "Tail"
		...
		tail_2.Size = Vector3.new(1.3841, 1.0396, 1.3597)
		tail_2.AssemblyLinearVelocity = Vector3.new(0, -8.9917, 0)
		tail_2.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
		tail_2.CFrame = CFrame.new(Vector3.new(-55.6056, 3.1784, -24.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			tailMotor6d_2.C0 = CFrame.new(Vector3.new(0, 1.2397, 1.6811))
	...
	backLeftLeg.TextureID = "rbxassetid://132699111454634"
	...
	backLeftLeg.CFrame = CFrame.new(Vector3.new(-54.5059, 2.3801, -25.3828)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		backLeftLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://93955720989450", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		backLeftLeg_2.TextureID = "rbxassetid://82894932470419"
		...
		backLeftLeg_2.CFrame = CFrame.new(Vector3.new(-54.5059, 2.3801, -25.3828)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	backRightLeg.TextureID = "rbxassetid://132699111454634"
	...
	backRightLeg.CFrame = CFrame.new(Vector3.new(-54.4985, 2.3801, -23.8043)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		backRightLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://120593423659094", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		backRightLeg_2.TextureID = "rbxassetid://82894932470419"
		...
		backRightLeg_2.CFrame = CFrame.new(Vector3.new(-54.4985, 2.3801, -23.8043)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	mainBody.TextureID = "rbxassetid://132699111454634"
	...
	mainBody.CFrame = CFrame.new(Vector3.new(-53.7519, 3.1542, -24.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		mainBody_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://92207515999262", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		mainBody_2.TextureID = "rbxassetid://132699111454634"
		...
		mainBody_2.Size = Vector3.new(3.2344, 2.8864, 2.9703)
		mainBody_2.AssemblyLinearVelocity = Vector3.new(0, -8.9917, 0)
		mainBody_2.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
		mainBody_2.CFrame = CFrame.new(Vector3.new(-53.7519, 3.1542, -24.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			mainBodyMotor6d_2.C0 = CFrame.new(Vector3.new(0, 1.9964, -0.1437))
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-53.8894, 1.9481, -24.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-53.8894, 1.9481, -24.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	humanoidRootPart.Parent = flowerBud
	...
	tongue.CFrame = CFrame.new(Vector3.new(-53.7515, 3.1542, -24.5938)) * CFrame.fromEulerAnglesXYZ(0, math.rad(35.0015), 0)
	do
		weldConstraint = Instance.new("WeldConstraint")
		weldConstraint.Parent = tongue
	end
	tongue.Parent = flowerBud
end

flowerBud.PrimaryPart = humanoidRootPart
