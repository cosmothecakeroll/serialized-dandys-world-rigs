...
do
	...
	leftUpperLeg.TextureID = "rbxassetid://123268694166967"
	...
	leftUpperLeg.CFrame = CFrame.new(Vector3.new(-51.4064, 3.4591, -108.3534)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftUpperLeg.Parent = blossomBuddy
	...
	animations.Parent = blossomBuddy
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-51.3893, 1.9481, -108.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-51.3893, 1.9481, -108.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = blossomBuddy
	...
	rightHand.TextureID = "rbxassetid://123268694166967"
	...
	rightHand.CFrame = CFrame.new(Vector3.new(-51.3936, 4.9761, -106.1738)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftHand.TextureID = "rbxassetid://123268694166967"
	...
	leftHand.CFrame = CFrame.new(Vector3.new(-51.3936, 4.9761, -110.0134)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftHand.Parent = blossomBuddy
	rightUpperTail = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://98356237197147", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	rightUpperTail.TextureID = "rbxassetid://123268694166967"
	...
	rightUpperTail.CFrame = CFrame.new(Vector3.new(-53.703, 4.2277, -107.9549)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rightUpperTail.Parent = blossomBuddy
	rightUpperArm = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://112842244587964", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	rightUpperArm.TextureID = "rbxassetid://123268694166967"
	...
	rightUpperArm.CFrame = CFrame.new(Vector3.new(-51.3936, 4.9091, -107.4403)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightUpperArm.Parent = blossomBuddy
	rightLowerArm = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://131846121384608", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	rightLowerArm.TextureID = "rbxassetid://123268694166967"
	...
	rightLowerArm.CFrame = CFrame.new(Vector3.new(-51.3936, 4.9091, -106.8149)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLowerArm.Parent = blossomBuddy
	rightLowerTail = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://98517205662252", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	rightLowerTail.TextureID = "rbxassetid://123268694166967"
	...
	rightLowerTail.CFrame = CFrame.new(Vector3.new(-53.3039, 4.0223, -107.8806)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLowerTail.Parent = blossomBuddy
	leftLowerTail = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://110345567847782", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	leftLowerTail.TextureID = "rbxassetid://123268694166967"
	...
	leftLowerTail.CFrame = CFrame.new(Vector3.new(-53.3039, 4.0223, -108.3066)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLowerTail.Parent = blossomBuddy
	leftUpperTail = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://96928803812046", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	leftUpperTail.TextureID = "rbxassetid://123268694166967"
	...
	leftUpperTail.CFrame = CFrame.new(Vector3.new(-53.703, 4.2277, -108.2323)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	leftUpperTail.Parent = blossomBuddy
	leftUpperArm = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://131671269359934", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	leftUpperArm.TextureID = "rbxassetid://123268694166967"
	...
	leftUpperArm.CFrame = CFrame.new(Vector3.new(-51.3936, 4.9091, -108.747)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftUpperArm.Parent = blossomBuddy
	leftLowerArm = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://123113097271927", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	leftLowerArm.TextureID = "rbxassetid://123268694166967"
	...
	leftLowerArm.CFrame = CFrame.new(Vector3.new(-51.3936, 4.9091, -109.3723)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLowerArm.Parent = blossomBuddy
	...
	rightFoot.TextureID = "rbxassetid://123268694166967"
	...
	rightFoot.CFrame = CFrame.new(Vector3.new(-51.2849, 2.1316, -107.8338)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	leftFoot.TextureID = "rbxassetid://123268694166967"
	...
	leftFoot.CFrame = CFrame.new(Vector3.new(-51.2849, 2.1316, -108.3534)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftFoot.Parent = blossomBuddy
	torso_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://106496844085903", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	torso_2.TextureID = "rbxassetid://123268694166967"
	torso_2.Name = "Torso"
	torso_2.CanTouch = false
	torso_2.CanQuery = false
	torso_2.Massless = true
	torso_2.AssemblyLinearVelocity = Vector3.yAxis * -4.9051
	torso_2.Size = Vector3.new(1.6585, 1.5202, 1.2043)
	torso_2.CFrame = CFrame.new(Vector3.new(-51.3522, 4.4277, -108.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	torso_2.Parent = blossomBuddy
	head_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://79891456145387", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	head_2.TextureID = "rbxassetid://123268694166967"
	head_2.Name = "Head"
	...
	head_2.CFrame = CFrame.new(Vector3.new(-51.7322, 6.6419, -108.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLowerLeg.TextureID = "rbxassetid://123268694166967"
	...
	rightLowerLeg.CFrame = CFrame.new(Vector3.new(-51.4615, 2.5569, -107.8336)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLowerLeg.Parent = blossomBuddy
	...
	leftLowerLeg.TextureID = "rbxassetid://123268694166967"
	...
	leftLowerLeg.CFrame = CFrame.new(Vector3.new(-51.4615, 2.5569, -108.3536)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLowerLeg.Parent = blossomBuddy
	...
	rightUpperLeg.TextureID = "rbxassetid://123268694166967"
	...
	rightUpperLeg.CFrame = CFrame.new(Vector3.new(-51.4064, 3.4591, -107.8338)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightUpperLeg.Parent = blossomBuddy
end

blossomBuddy.PrimaryPart = humanoidRootPart
