...
local alphaWolf = Instance.new("Model")
alphaWolf.Name = "AlphaWolf"
do
	...
	blinkingParts.Parent = alphaWolf
	...
	head_2.TextureID = "rbxassetid://101658474137745"
	head_2.Name = "Head"
	...
	head_2.CFrame = CFrame.new(Vector3.new(-43.7501, 3.7679, -45.9382)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		head_3 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://131403200159774", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		head_3.TextureID = "rbxassetid://101658474137745"
		head_3.Name = "_Head"
		head_3.CanCollide = false
		head_3.CanTouch = false
		head_3.Massless = true
		head_3.CanQuery = false
		head_3.Size = Vector3.new(3.4725, 3.7955, 0.333)
		...
		head_3.CFrame = CFrame.new(Vector3.new(-43.7501, 3.7679, -45.9382)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		head_3.PivotOffset = CFrame.new(Vector3.new(0.3447, -3.7236, 0.1509)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
		do
			headMotor6d_2 = Instance.new("Motor6D")
			headMotor6d_2.Name = "HeadMotor6D"
			headMotor6d_2.MaxVelocity = 0.1
			headMotor6d_2.C0 = CFrame.new(Vector3.new(-0.3448, 3.7235, -0.151))
	...
	headGlass.CFrame = CFrame.new(Vector3.new(-43.7501, 4.2526, -45.5938)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		decal.Texture = "rbxassetid://128685472486574"
		decal.Parent = headGlass
		headGlass_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://74544774863824", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		...
		headGlass_2.Size = Vector3.new(2.1502, 2.1833, 0.14)
		headGlass_2.Material = Enum.Material.SmoothPlastic
		headGlass_2.CFrame = CFrame.new(Vector3.new(-43.7501, 4.2526, -45.5938)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		headGlass_2.PivotOffset = CFrame.new(Vector3.new(0, -4.2081, 0.1509)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
		do
			headGlassMotor6d_2 = Instance.new("Motor6D")
			headGlassMotor6d_2.Name = "HeadGlassMotor6D"
			headGlassMotor6d_2.MaxVelocity = 0.1
			headGlassMotor6d_2.C0 = CFrame.new(Vector3.new(0, 4.208, -0.151))
			headGlassMotor6d_2.Parent = headGlass_2
			local decal_2 = Instance.new("Decal")
			decal_2.Texture = "rbxassetid://128685472486574"
	...
	leftArm.TextureID = "rbxassetid://101658474137745"
	...
	leftArm.CFrame = CFrame.new(Vector3.new(-43.8924, 2.8339, -46.8706)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftArm_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://93904519588246", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftArm_2.TextureID = "rbxassetid://101658474137745"
		leftArm_2.Name = "LeftArm"
		leftArm_2.CanCollide = false
		leftArm_2.CanTouch = false
		leftArm_2.Massless = true
		leftArm_2.CanQuery = false
		leftArm_2.Size = Vector3.new(1.977, 0.66, 0.4407)
		...
		leftArm_2.CFrame = CFrame.new(Vector3.new(-43.8924, 2.8339, -46.8706)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		leftArm_2.PivotOffset = CFrame.new(Vector3.new(1.2676, -2.7864, -0.0013)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
		do
			leftArmMotor6d_2 = Instance.new("Motor6D")
			leftArmMotor6d_2.Name = "LeftArmMotor6D"
			leftArmMotor6d_2.MaxVelocity = 0.1
			leftArmMotor6d_2.C0 = CFrame.new(Vector3.new(-1.2677, 2.7863, 0.0012))
	...
	leftLeg.TextureID = "rbxassetid://101658474137745"
	...
	leftLeg.CFrame = CFrame.new(Vector3.new(-43.7467, 0.9977, -45.8276)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://93109956569657", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftLeg_2.TextureID = "rbxassetid://101658474137745"
		leftLeg_2.Name = "LeftLeg"
		leftLeg_2.CanCollide = false
		leftLeg_2.CanTouch = false
		leftLeg_2.Massless = true
		leftLeg_2.CanQuery = false
		leftLeg_2.Size = Vector3.new(0.5161, 1.892, 0.6702)
		...
		leftLeg_2.CFrame = CFrame.new(Vector3.new(-43.7467, 0.9977, -45.8276)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		leftLeg_2.PivotOffset = CFrame.new(Vector3.new(0.2341, -0.9401, 0.123)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
		do
			leftLegMotor6d_2 = Instance.new("Motor6D")
			leftLegMotor6d_2.Name = "LeftLegMotor6D"
			leftLegMotor6d_2.MaxVelocity = 0.1
			leftLegMotor6d_2.C0 = CFrame.new(Vector3.new(-0.2342, 0.94, -0.1231))
	...
	magnifyingGlassGeo.TextureID = "rbxassetid://101658474137745"
	...
	magnifyingGlassGeo.CFrame = CFrame.new(Vector3.new(-43.8894, 2.2302, -45.5956)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		magnifyingGlassGeo_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://72323265514045", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		magnifyingGlassGeo_2.TextureID = "rbxassetid://87984663866153"
		...
		magnifyingGlassGeo_2.Size = Vector3.new(0.698, 1.2779, 0.2099)
		...
		magnifyingGlassGeo_2.CFrame = CFrame.new(Vector3.new(-43.8894, 2.2302, -45.5956)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		magnifyingGlassGeo_2.PivotOffset = CFrame.new(Vector3.new(0.002, -2.1883, 0)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
		do
			...
			magnifyingGlassGeoMotor6d_2.C0 = CFrame.new(Vector3.new(-0.0021, 2.1882, 0))
	...
	magnifyingGlassGeo.Parent = alphaWolf
	...
	rightArm.TextureID = "rbxassetid://101658474137745"
	...
	rightArm.CFrame = CFrame.new(Vector3.new(-43.8924, 2.8339, -44.3166)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightArm_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://109050587246325", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightArm_2.TextureID = "rbxassetid://101658474137745"
		...
		rightArm_2.Size = Vector3.new(1.977, 0.66, 0.4407)
		...
		rightArm_2.CFrame = CFrame.new(Vector3.new(-43.8924, 2.8339, -44.3166)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		rightArm_2.PivotOffset = CFrame.new(Vector3.new(-1.2677, -2.7864, -0.0013)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
		do
			rightArmMotor6d_2 = Instance.new("Motor6D")
			rightArmMotor6d_2.Name = "RightArmMotor6D"
			rightArmMotor6d_2.MaxVelocity = 0.1
			rightArmMotor6d_2.C0 = CFrame.new(Vector3.new(1.2676, 2.7863, 0.0012))
	...
	rightLeg.TextureID = "rbxassetid://101658474137745"
	...
	rightLeg.CFrame = CFrame.new(Vector3.new(-43.7467, 0.9977, -45.3596)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://132419691735030", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightLeg_2.TextureID = "rbxassetid://101658474137745"
		...
		rightLeg_2.Size = Vector3.new(0.5161, 1.892, 0.6702)
		...
		rightLeg_2.CFrame = CFrame.new(Vector3.new(-43.7467, 0.9977, -45.3596)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		rightLeg_2.PivotOffset = CFrame.new(Vector3.new(-0.2342, -0.9401, 0.123)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
		do
			rightLegMotor6d_2 = Instance.new("Motor6D")
			rightLegMotor6d_2.Name = "RightLegMotor6D"
			rightLegMotor6d_2.MaxVelocity = 0.1
			rightLegMotor6d_2.C0 = CFrame.new(Vector3.new(0.2341, 0.94, -0.1231))
	...
	torso.TextureID = "rbxassetid://101658474137745"
	torso.Name = "Torso"
	...
	torso.CFrame = CFrame.new(Vector3.new(-43.8605, 2.3431, -45.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		torso_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://103081696358157", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		torso_2.TextureID = "rbxassetid://101658474137745"
		torso_2.Name = "Torso"
		torso_2.CanCollide = false
		torso_2.CanTouch = false
		torso_2.Massless = true
		torso_2.CanQuery = false
		torso_2.Size = Vector3.new(1.11, 1.6885, 0.8961)
		...
		torso_2.CFrame = CFrame.new(Vector3.new(-43.8605, 2.3431, -45.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		torso_2.PivotOffset = CFrame.new(Vector3.new(-0.0045, -2.2971, 0.0021)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
		do
			torsoMotor6d_2 = Instance.new("Motor6D")
			torsoMotor6d_2.Name = "TorsoMotor6D"
			torsoMotor6d_2.MaxVelocity = 0.1
			torsoMotor6d_2.C0 = CFrame.new(Vector3.new(0.0044, 2.297, -0.0022))
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-43.8894, 0.0456, -45.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-43.8894, 1.9481, -45.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = alphaWolf
end

alphaWolf.PrimaryPart = humanoidRootPart
