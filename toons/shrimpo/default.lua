...
local shrimpo = Instance.new("Model")
shrimpo.Name = "Shrimpo"
shrimpo.ModelStreamingMode = Enum.ModelStreamingMode.PersistentPerPlayer
do
	...
	do
		...
		run.Name = "Run"
		run.AnimationId = "rbxassetid://125473800038706"
		run.Parent = animations
		local walk = Instance.new("Animation")
		walk.Name = "Walk"
		walk.AnimationId = "rbxassetid://89874032275829"
		walk.Parent = animations
		local idle = Instance.new("Animation")
		idle.Name = "Idle"
		idle.AnimationId = "rbxassetid://134164252447294"
		idle.Parent = animations
		local quirk = Instance.new("Animation")
		quirk.Name = "Quirk"
		quirk.AnimationId = "rbxassetid://137784062163615"
		quirk.Parent = animations
		local decode = Instance.new("Animation")
		decode.Name = "Decode"
		decode.AnimationId = "rbxassetid://114803861801673"
		decode.Parent = animations
	end
	animations.Parent = shrimpo
	local config = Instance.new("Configuration")
	config.Name = "Config"
	do
		local normalTexture = Instance.new("Decal")
		normalTexture.Name = "NormalTexture"
		normalTexture.Texture = "rbxassetid://93443522375972"
		normalTexture.Parent = config
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://95265075845404"
		blinkTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://92191726840300"
	...
	humanoid.Parent = shrimpo
	local toonName = Instance.new("StringValue")
	toonName.Name = "ToonName"
	toonName.Value = "Shrimpo"
	toonName.Parent = shrimpo
	...
	head.TextureID = "rbxassetid://93443522375972"
	head.Name = "Head"
	...
	head.CFrame = CFrame.new(Vector3.new(-41.0867, 4.5041, -65.6218)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		stickerOverride.CFrame = CFrame.new(Vector3.new(0, 4.631, -0.5911))
	...
	leftArm.TextureID = "rbxassetid://93443522375972"
	...
	leftArm.CFrame = CFrame.new(Vector3.new(-40.4294, 2.7252, -66.7706)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLeg.TextureID = "rbxassetid://93443522375972"
	...
	leftLeg.CFrame = CFrame.new(Vector3.new(-40.243, 1.1526, -65.8111)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightArm.TextureID = "rbxassetid://93443522375972"
	...
	rightArm.CFrame = CFrame.new(Vector3.new(-40.4294, 2.7252, -64.4166)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLeg.TextureID = "rbxassetid://93443522375972"
	...
	rightLeg.CFrame = CFrame.new(Vector3.new(-40.243, 1.1526, -65.3761)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	torso.TextureID = "rbxassetid://93443522375972"
	torso.Name = "Torso"
	torso.Massless = true
	...
	torso.CFrame = CFrame.new(Vector3.new(-40.3893, 2.3116, -65.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-40.3893, 0.3834, -65.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-40.3893, 1.9481, -65.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = shrimpo
end

shrimpo.PrimaryPart = humanoidRootPart
