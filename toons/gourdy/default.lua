...
local gourdy = Instance.new("Model")
gourdy.Name = "Gourdy"
gourdy.ModelStreamingMode = Enum.ModelStreamingMode.PersistentPerPlayer
do
	...
	do
		...
		run.Name = "Run"
		run.AnimationId = "rbxassetid://120512093330969"
		run.Parent = animations
		local walk = Instance.new("Animation")
		walk.Name = "Walk"
		walk.AnimationId = "rbxassetid://87747157557131"
		walk.Parent = animations
		local idle = Instance.new("Animation")
		idle.Name = "Idle"
		idle.AnimationId = "rbxassetid://107346730664441"
		idle.Parent = animations
		local quirk = Instance.new("Animation")
		quirk.Name = "Quirk"
		quirk.AnimationId = "rbxassetid://110535265043019"
		quirk.Parent = animations
		local decode = Instance.new("Animation")
		decode.Name = "Decode"
		decode.AnimationId = "rbxassetid://114262687589634"
		decode.Parent = animations
		local ability = Instance.new("Animation")
		ability.Name = "Ability"
		ability.AnimationId = "rbxassetid://89405557343555"
		ability.Parent = animations
	end
	animations.Parent = gourdy
	local config = Instance.new("Configuration")
	config.Name = "Config"
	do
		local normalTexture = Instance.new("Decal")
		normalTexture.Name = "NormalTexture"
		normalTexture.Texture = "rbxassetid://95890575767181"
		normalTexture.Parent = config
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://133494896907639"
		blinkTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://130093029155268"
	...
	blinkingParts.Parent = gourdy
	local toonName = Instance.new("StringValue")
	toonName.Name = "ToonName"
	toonName.Value = "Gourdy"
	toonName.Parent = gourdy
	...
	torso.CFrame = CFrame.new(Vector3.new(-40.3898, 3.7159, -15.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLeg.CFrame = CFrame.new(Vector3.new(-40.2716, 2.6941, -14.8667)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLeg.CFrame = CFrame.new(Vector3.new(-40.2716, 2.6941, -15.3205)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	tail.CFrame = CFrame.new(Vector3.new(-42.4963, 3.757, -15.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	headGeo.CFrame = CFrame.new(Vector3.new(-40.3893, 5.2211, -15.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftArm.CFrame = CFrame.new(Vector3.new(-40.3373, 4.0753, -16.4928)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightArm.CFrame = CFrame.new(Vector3.new(-40.3373, 4.0753, -13.6944)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	hat.CFrame = CFrame.new(Vector3.new(-40.3892, 6.8682, -15.0932)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-40.3893, 1.9481, -15.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-40.3893, 1.9481, -15.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = gourdy
end

gourdy.PrimaryPart = humanoidRootPart
head.Value = headGeo
