...
do
	...
	do
		...
		normalTexture.Texture = "rbxassetid://128356859073604"
		normalTexture.Parent = config
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://75719910852011"
		blinkTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://117393833656119"
	...
	humanoid.Parent = crinklingLeaves
	...
	animations.Parent = crinklingLeaves
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-45.8894, 1.9481, -15.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = crinklingLeaves
	...
	rightLeg.CFrame = CFrame.new(Vector3.new(-45.7716, 2.6941, -14.8667)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightLeg_2.CFrame = CFrame.new(Vector3.new(-45.7716, 2.6941, -14.8667)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			rightLeg_3 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://84197900882140", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
			rightLeg_3.TextureID = "rbxassetid://110611330780177"
			...
			rightLeg_3.Size = Vector3.new(0.4133, 1.543, 0.5339)
			rightLeg_3.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
			rightLeg_3.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
			rightLeg_3.CFrame = CFrame.new(Vector3.new(-45.7716, 2.6941, -14.8667)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
			rightLeg_3.PivotOffset = CFrame.new(Vector3.new(-0.2269, -0.746, 0.1177))
			do
				rightLegMotor6d_3 = Instance.new("Motor6D")
				rightLegMotor6d_3.Name = "RightLegMotor6D"
				rightLegMotor6d_3.MaxVelocity = 0.1
				rightLegMotor6d_3.C0 = CFrame.new(Vector3.new(0.2268, 0.7459, -0.1178))
	...
	rightLeg.Parent = crinklingLeaves
	...
	leftLeg.CFrame = CFrame.new(Vector3.new(-45.7716, 2.6941, -15.3205)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftLeg_2.CFrame = CFrame.new(Vector3.new(-45.7716, 2.6941, -15.3205)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			leftLeg_3 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://75860944434097", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
			leftLeg_3.TextureID = "rbxassetid://110611330780177"
			leftLeg_3.Name = "LeftLeg"
			leftLeg_3.CanCollide = false
			leftLeg_3.CanTouch = false
			leftLeg_3.Massless = true
			leftLeg_3.CanQuery = false
			leftLeg_3.Size = Vector3.new(0.4133, 1.543, 0.5339)
			leftLeg_3.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
			leftLeg_3.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
			leftLeg_3.CFrame = CFrame.new(Vector3.new(-45.7716, 2.6941, -15.3205)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
			leftLeg_3.PivotOffset = CFrame.new(Vector3.new(0.2268, -0.746, 0.1177))
			do
				leftLegMotor6d_3 = Instance.new("Motor6D")
				leftLegMotor6d_3.Name = "LeftLegMotor6D"
				leftLegMotor6d_3.MaxVelocity = 0.1
				leftLegMotor6d_3.C0 = CFrame.new(Vector3.new(-0.2269, 0.7459, -0.1178))
	...
	leftLeg.Parent = crinklingLeaves
	...
	rightArm.CFrame = CFrame.new(Vector3.new(-45.8373, 4.0753, -13.6944)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightArm_2.CFrame = CFrame.new(Vector3.new(-45.8373, 4.0753, -13.6944)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			rightArm_3 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://95133791402615", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
			rightArm_3.TextureID = "rbxassetid://110611330780177"
			...
			rightArm_3.CFrame = CFrame.new(Vector3.new(-45.8373, 4.0753, -13.6944)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
			rightArm_3.PivotOffset = CFrame.new(Vector3.new(-1.3992, -2.1272, 0.052))
			do
	...
	rightArm.Parent = crinklingLeaves
	...
	tail.CFrame = CFrame.new(Vector3.new(-47.9964, 3.757, -15.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		tail_2.CFrame = CFrame.new(Vector3.new(-47.9964, 3.757, -15.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			taill = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://83068867646116", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
			taill.TextureID = "rbxassetid://110611330780177"
			taill.Name = "Taill"
			taill.CanCollide = false
			taill.CanTouch = false
			taill.Massless = true
			taill.CanQuery = false
			taill.Size = Vector3.new(0.4954, 1.3487, 3.8952)
			taill.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
			taill.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
			taill.CFrame = CFrame.new(Vector3.new(-47.9964, 3.757, -15.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
			taill.PivotOffset = CFrame.new(Vector3.new(0, -1.6571, -2.107))
			do
				taillMotor6d = Instance.new("Motor6D")
				taillMotor6d.Name = "TaillMotor6D"
				taillMotor6d.MaxVelocity = 0.1
				taillMotor6d.C0 = CFrame.new(Vector3.new(0, 1.657, 2.1069))
				taillMotor6d.Parent = taill
	...
	torso.CFrame = CFrame.new(Vector3.new(-45.8898, 3.7159, -15.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		torso_2.CFrame = CFrame.new(Vector3.new(-45.8898, 3.7159, -15.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			torso_3 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://106880868362754", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
			torso_3.TextureID = "rbxassetid://110611330780177"
			torso_3.Name = "Torso"
			torso_3.Massless = true
			torso_3.CanTouch = false
			torso_3.CanQuery = false
			torso_3.Size = Vector3.new(0.8461, 1.1381, 0.8822)
			torso_3.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
			torso_3.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
			torso_3.CFrame = CFrame.new(Vector3.new(-45.8898, 3.7159, -15.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
			torso_3.PivotOffset = CFrame.new(Vector3.new(0, -1.7678, 0.0987))
			do
				torsoMotor6d_3 = Instance.new("Motor6D")
				torsoMotor6d_3.Name = "TorsoMotor6D"
				torsoMotor6d_3.MaxVelocity = 0.1
				torsoMotor6d_3.C0 = CFrame.new(Vector3.new(0, 1.7677, -0.0988))
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-45.8894, 1.9481, -15.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rootPart.Parent = crinklingLeaves
	...
	leftArm.CFrame = CFrame.new(Vector3.new(-45.8373, 4.0753, -16.4928)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftArm_2.CFrame = CFrame.new(Vector3.new(-45.8373, 4.0753, -16.4928)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			leftArm_3 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://111712025254481", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
			leftArm_3.TextureID = "rbxassetid://110611330780177"
			...
			leftArm_3.CFrame = CFrame.new(Vector3.new(-45.8373, 4.0753, -16.4928)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
			leftArm_3.PivotOffset = CFrame.new(Vector3.new(1.3991, -2.1272, 0.052))
			do
	...
	leftArm.Parent = crinklingLeaves
	...
	hat_2.CFrame = CFrame.new(Vector3.new(-45.8892, 6.8682, -15.0932)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		hat_3.CFrame = CFrame.new(Vector3.new(-45.8892, 6.8682, -15.0932)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			hat_4 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://119851157461049", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
			hat_4.TextureID = "rbxassetid://110611330780177"
			hat_4.Name = "Hat"
			hat_4.CanCollide = false
			hat_4.CanTouch = false
			hat_4.Massless = true
			hat_4.CanQuery = false
			hat_4.Size = Vector3.new(2.3192, 1.4544, 2.4145)
			hat_4.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
			hat_4.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
			hat_4.CFrame = CFrame.new(Vector3.new(-45.8892, 6.8682, -15.0932)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
			hat_4.PivotOffset = CFrame.new(Vector3.new(0, -4.9098, 0))
			do
				hatMotor6d_3 = Instance.new("Motor6D")
				hatMotor6d_3.Name = "HatMotor6D"
				hatMotor6d_3.MaxVelocity = 0.1
				hatMotor6d_3.C0 = CFrame.new(Vector3.new(0, 1.6367, 0))
	...
	headGeo.CFrame = CFrame.new(Vector3.new(-45.8894, 5.2211, -15.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		headGeo_2.CFrame = CFrame.new(Vector3.new(-45.8894, 5.2211, -15.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			head_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://125023075458307", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
			head_2.TextureID = "rbxassetid://110611330780177"
			head_2.Name = "Head"
			...
			head_2.CFrame = CFrame.new(Vector3.new(-45.8894, 5.2211, -15.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
			head_2.PivotOffset = CFrame.new(Vector3.new(0, -3.273, 0))
			do
	...
	headGeo.Parent = crinklingLeaves
end

crinklingLeaves.PrimaryPart = humanoidRootPart
