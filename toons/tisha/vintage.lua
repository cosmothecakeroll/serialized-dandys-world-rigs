local humanoidRootPart, featherStick, featherStickMotor6d, torso, torsoMotor6d, head, headMotor6d, leftLeg, leftLegMotor6d, rightLeg, rightLegMotor6d, leftArm, leftArmMotor6d, rightArm, rightArmMotor6d, rootPart, weldConstraint

local vintageTisha = Instance.new("Model")
vintageTisha.Name = "VintageTisha"
do
	local showDuster = Instance.new("Script")
	showDuster.Name = "ShowDuster"
	showDuster.Parent = vintageTisha
	...
	animations.Parent = vintageTisha
	humanoidRootPart = Instance.new("Part")
	humanoidRootPart.Name = "HumanoidRootPart"
	humanoidRootPart.Transparency = 1
	humanoidRootPart.AssemblyLinearVelocity = Vector3.new(-0.0401, -0.5305, 0.7385)
	humanoidRootPart.Size = Vector3.new(2, 2, 1)
	humanoidRootPart.AssemblyAngularVelocity = Vector3.new(-2.53, -1.4708, 0.0321)
	humanoidRootPart.CustomPhysicalProperties = PhysicalProperties.new(15, 1, 0.3, 1, 1, 1)
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-46.3893, 1.9481, -92.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = vintageTisha
	...
	featherStick.TextureID = "rbxassetid://80193849347450"
	...
	featherStick.AssemblyLinearVelocity = Vector3.new(-0.0401, -0.5305, 0.7385)
	featherStick.AssemblyAngularVelocity = Vector3.new(-2.53, -1.4708, 0.0321)
	featherStick.CFrame = CFrame.new(Vector3.new(-46.3893, 5.4033, -89.5559)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	featherStick.Parent = vintageTisha
	...
	torso.TextureID = "rbxassetid://80193849347450"
	torso.Name = "Torso"
	torso.Massless = true
	torso.CanTouch = false
	torso.CanQuery = false
	torso.Size = Vector3.new(1.8363, 1.9594, 1.6396)
	torso.AssemblyLinearVelocity = Vector3.new(-0.0401, -0.5305, 0.7385)
	torso.AssemblyAngularVelocity = Vector3.new(-2.53, -1.4708, 0.0321)
	torso.CFrame = CFrame.new(Vector3.new(-46.3888, 3.9267, -92.5944)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	head.TextureID = "rbxassetid://80193849347450"
	head.Name = "Head"
	head.CanQuery = false
	head.CanTouch = false
	head.Massless = true
	...
	head.AssemblyLinearVelocity = Vector3.new(-0.0401, -0.5305, 0.7385)
	head.AssemblyAngularVelocity = Vector3.new(-2.53, -1.4708, 0.0321)
	head.CFrame = CFrame.new(Vector3.new(-46.4128, 6.1285, -92.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	leftLeg.TextureID = "rbxassetid://80193849347450"
	...
	leftLeg.AssemblyAngularVelocity = Vector3.new(-2.53, -1.4708, 0.0321)
	leftLeg.AssemblyLinearVelocity = Vector3.new(-0.0401, -0.5305, 0.7385)
	leftLeg.CFrame = CFrame.new(Vector3.new(-46.2384, 2.6277, -92.8189)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLeg.TextureID = "rbxassetid://80193849347450"
	...
	rightLeg.AssemblyAngularVelocity = Vector3.new(-2.53, -1.4708, 0.0321)
	rightLeg.AssemblyLinearVelocity = Vector3.new(-0.0401, -0.5305, 0.7385)
	rightLeg.CFrame = CFrame.new(Vector3.new(-46.2384, 2.6277, -92.3683)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftArm.TextureID = "rbxassetid://80193849347450"
	...
	leftArm.AssemblyAngularVelocity = Vector3.new(-2.53, -1.4708, 0.0321)
	leftArm.AssemblyLinearVelocity = Vector3.new(-0.0401, -0.5305, 0.7385)
	leftArm.CFrame = CFrame.new(Vector3.new(-46.3658, 4.5691, -93.8216)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightArm.TextureID = "rbxassetid://80193849347450"
	...
	rightArm.AssemblyAngularVelocity = Vector3.new(-2.53, -1.4708, 0.0321)
	rightArm.AssemblyLinearVelocity = Vector3.new(-0.0401, -0.5305, 0.7385)
	rightArm.CFrame = CFrame.new(Vector3.new(-46.3658, 4.5691, -91.3656)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rootPart.AssemblyAngularVelocity = Vector3.new(-2.53, -1.4708, 0.0321)
	rootPart.Size = Vector3.new(2, 2, 1)
	rootPart.AssemblyLinearVelocity = Vector3.new(-0.0401, -0.5305, 0.7385)
	rootPart.CFrame = CFrame.new(Vector3.new(-46.3893, 1.9481, -92.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rootPart.Parent = vintageTisha
end

vintageTisha.PrimaryPart = humanoidRootPart
