local head, headMotor6d, leftArm, leftArmMotor6d, leftLeg, leftLegMotor6d, lidGeo, lidGeoMotor6d, rightArm, rightArmMotor6d, rightLeg, rightLegMotor6d, torso, torsoMotor6d, rootPart, weldConstraint, humanoidRootPart

local gigi = Instance.new("Model")
gigi.Name = "Gigi"
gigi.ModelStreamingMode = Enum.ModelStreamingMode.PersistentPerPlayer
do
	local toonName = Instance.new("StringValue")
	toonName.Name = "ToonName"
	toonName.Value = "Gigi"
	toonName.Parent = gigi
	local animations = Instance.new("Configuration")
	animations.Name = "Animations"
	do
		local ability = Instance.new("Animation")
		ability.Name = "Ability"
		ability.AnimationId = "rbxassetid://136449500016336"
		ability.Parent = animations
		local decode = Instance.new("Animation")
		decode.Name = "Decode"
		decode.AnimationId = "rbxassetid://91487303759640"
		decode.Parent = animations
		local idle = Instance.new("Animation")
		idle.Name = "Idle"
		idle.AnimationId = "rbxassetid://86845312979604"
		idle.Parent = animations
		local quirk = Instance.new("Animation")
		quirk.Name = "Quirk"
		quirk.AnimationId = "rbxassetid://103482473622180"
		quirk.Parent = animations
		local run = Instance.new("Animation")
		run.Name = "Run"
		run.AnimationId = "rbxassetid://72886416080806"
		run.Parent = animations
		local walk = Instance.new("Animation")
		walk.Name = "Walk"
		walk.AnimationId = "rbxassetid://116695101289301"
		walk.Parent = animations
	end
	animations.Parent = gigi
	...
	do
		...
		blinkTexture.Texture = "rbxassetid://75862402844819"
		blinkTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://132651636721231"
		hurtTexture.Parent = config
		local normalTexture = Instance.new("Decal")
		normalTexture.Name = "NormalTexture"
		normalTexture.Texture = "rbxassetid://81975910202642"
	...
	head.TextureID = "rbxassetid://71745710082428"
	head.Name = "Head"
	...
	head.CFrame = CFrame.new(Vector3.new(-40.3531, 3.8095, 8.9089)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		stickerOverride.CFrame = CFrame.new(Vector3.yAxis * 5.604)
		stickerOverride.Parent = head
		local bubbleChat = Instance.new("Attachment")
		bubbleChat.Name = "BubbleChat"
		bubbleChat.CFrame = CFrame.new(Vector3.yAxis * 1.899)
	...
	leftArm.CFrame = CFrame.new(Vector3.new(-40.2888, 2.6119, 7.129)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLeg.CFrame = CFrame.new(Vector3.new(-40.168, 0.9909, 8.6652)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	lidGeo.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	lidGeo.Size = Vector3.new(3.0943, 1.1337, 2.4581)
	lidGeo.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
	lidGeo.Material = Enum.Material.Glass
	lidGeo.CFrame = CFrame.new(Vector3.new(-40.3517, 5.2655, 8.9088)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightArm.CFrame = CFrame.new(Vector3.new(-40.2888, 2.6119, 10.6837)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLeg.CFrame = CFrame.new(Vector3.new(-40.168, 0.9909, 9.1476)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	torso.CFrame = CFrame.new(Vector3.new(-40.3093, 2.3016, 8.9065)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-40.3893, 0.112, 8.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-40.3893, 1.9481, 8.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = gigi
end

gigi.PrimaryPart = humanoidRootPart
