...
local sprout = Instance.new("Model")
sprout.Name = "Sprout"
sprout.ModelStreamingMode = Enum.ModelStreamingMode.PersistentPerPlayer
do
	...
	do
		...
		normalTexture.Texture = "rbxassetid://109251240386327"
		normalTexture.Parent = config
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://70454045994432"
		blinkTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://74326508320884"
	...
	humanoid.Parent = sprout
	local animations = Instance.new("Configuration")
	animations.Name = "Animations"
	do
		local run = Instance.new("Animation")
		run.Name = "Run"
		run.AnimationId = "rbxassetid://94432894741177"
		run.Parent = animations
		local walk = Instance.new("Animation")
		walk.Name = "Walk"
		walk.AnimationId = "rbxassetid://99920926637273"
		walk.Parent = animations
		local idle = Instance.new("Animation")
		idle.Name = "Idle"
		idle.AnimationId = "rbxassetid://117264404725989"
		idle.Parent = animations
		local quirk = Instance.new("Animation")
		quirk.Name = "Quirk"
		quirk.AnimationId = "rbxassetid://91447068261729"
		quirk.Parent = animations
		local ability = Instance.new("Animation")
		ability.Name = "Ability"
		ability.AnimationId = "rbxassetid://101476592590917"
		ability.Parent = animations
		local decode = Instance.new("Animation")
		decode.Name = "Decode"
		decode.AnimationId = "rbxassetid://118328687309061"
		decode.Parent = animations
	end
	animations.Parent = sprout
	...
	blinkingParts.Parent = sprout
	local toonName = Instance.new("StringValue")
	toonName.Name = "ToonName"
	toonName.Value = "Sprout"
	toonName.Parent = sprout
	...
	sproutRigV002HeadGeo.TextureID = "rbxassetid://109251240386327"
	...
	sproutRigV002HeadGeo.CFrame = CFrame.new(Vector3.new(-40.3117, 6.7164, -76.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	sproutRigV002HeadGeo.Parent = sprout
	...
	sproutRigV002TorsoGeo.CFrame = CFrame.new(Vector3.new(-40.4682, 4.2841, -76.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	sproutRigV002TorsoGeo.Parent = sprout
	...
	sproutRigV002LeftArm.CFrame = CFrame.new(Vector3.new(-40.5319, 4.6682, -78.0405)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	sproutRigV002LeftArm.Parent = sprout
	...
	sproutRigV002LeftLeg.CFrame = CFrame.new(Vector3.new(-40.2421, 2.8511, -76.8483)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	sproutRigV002LeftLeg.Parent = sprout
	...
	sproutRigV002RightLeg.CFrame = CFrame.new(Vector3.new(-40.2421, 2.8511, -76.3389)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	sproutRigV002RightLeg.Parent = sprout
	...
	sproutRigV002RightArm.CFrame = CFrame.new(Vector3.new(-40.5319, 4.6682, -75.1467)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	sproutRigV002RightArm.Parent = sprout
	...
	sproutRigV002CharmSavory.CFrame = CFrame.new(Vector3.new(-40.496, 4.155, -76.5918)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	sproutRigV002CharmSavory.Parent = sprout
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-40.3894, 1.9481, -76.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-40.3893, 1.9481, -76.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = sprout
end

sprout.PrimaryPart = humanoidRootPart
